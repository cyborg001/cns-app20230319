...
class Sismo(models.Model):
    ...
    profundidad = models.FloatField(default=10.0)
    magnitud = models.FloatField()
    comentario = models.CharField(max_length=150)
    magC= models.FloatField(blank=True, default=0)
    magL = models.FloatField(blank=True,default=0)
    magW = models.FloatField(blank=True,default=0)
    rms = models.FloatField()
    sentido = models.BooleanField()
    data_estaciones = models.TextField(max_length=1024*6,blank=True, default="")
